...
func InitOptionMap() {
	...
	common.OptionMap["HiddenModelRatio"] = ratio_setting.HiddenModelRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "HiddenModelRatio":
		err = ratio_setting.UpdateHiddenModelRatioByJSONString(value)
	case "GroupRatio":
